...
<head>
    ...
    {block name='frontend_index_header_meta_tags'}
        {block name='frontend_index_header_meta_tags_inner'}
            <meta name="author" content="{s name='IndexMetaAuthor'}{/s} | Thomas Neef" />
    ...
    {block name='frontend_index_header_meta_tags_android'}
        <meta name="theme-color" content="#eea037" />
    {/block}
    ...
    {block name="frontend_index_header_css_screen"}
        ...
        {foreach $lessFiles as $stylesheet}
            {block name="frontend_index_header_css_screen_stylesheet"}
                <link href="{preload file={$stylesheet} as="style"}" media="print" onload="this.media='all'" rel="stylesheet" type="text/css" />
                <link href="https://fonts.googleapis.com/css?family=Montserrat::ital,wght@0,300;0,400;0,500;0,600;0,700;0,900;1,500&display=swap" rel="stylesheet">
            {/block}
        {/foreach}
...
{*
        <script async type="text/javascript" src="https://userlike-cdn-widgets.s3-eu-west-1.amazonaws.com/1ec42c70eefdaaee0a027971289fcfd02ea562fb0780a115320254c32e859b6c.js"></script>
*}
    {/block}
