...
<div class="orangebytes--payment-icon-stripe">
    <div class="container">
        ...
        <div class="title">{s name="sFooterPaymentTitle"}Unsere Zahlungs- und Versandarten:{/s}</div>
    ...
    <div class="footer--jos-icon">
        <a href="#">
            <img src="{link file='frontend/_public/src/img/footer_icon.png'}" alt="Zum Seitenanfang" />
        </a>
    </div>
