...
namespace Shopware\Themes\ActionShop;
...
class Theme extends \Shopware\Components\Theme
{
    ...
    protected $name = 'ActionShop24 Theme';
    protected $description = 'Responsive, SEO-ready ActionShop optimiert';
    protected $author = 'Thomas Neef';

    protected $inheritanceConfig = false;

    protected $css = [
        'src/css/fa-all.min.css'
    ];
    ...
    private $themeFontDefaults = [
        'font-base-stack' => '"Quicksand","Open Sans", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif;',
    ...
    private function createMainConfigTab()
    {
        ...
        $fieldSet->addElement(
            $this->createCheckboxField(
                ...
                true,
                ['attributes' => ['boxLabel' => '__scroll-to-top-label__']]
            )
        );
