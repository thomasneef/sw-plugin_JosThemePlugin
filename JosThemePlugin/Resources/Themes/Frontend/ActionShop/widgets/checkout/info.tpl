...
{block name="frontend_index_checkout_actions_notepad"}
    <li class="navigation--entry entry--notepad" role="menuitem">
        <a href="{url controller='note'}" title="{"{s namespace='frontend/index/checkout_actions' name='IndexLinkNotepad'}{/s}"|escape}" class="btn">
            ...
            {/if}<br>
            <span class="orangebytes-notepad-label">{s namespace='frontend/index/checkout_actions' name='OrangebytesShopNavigationNotepadLabel'}Merkzettel{/s}</span>
        </a>
    </li>
{/block}
...
{block name="frontend_index_checkout_actions_cart"}
    <li class="navigation--entry entry--cart" role="menuitem">
        <a class="btn is--icon-left cart--link" href="{url controller='checkout' action='cart'}" title="{"{s namespace='frontend/index/checkout_actions' name='IndexLinkCart'}{/s}"|escape}">
            ...
            <br>
            <span class="cart--amount orangebytes-basketlabel"><span>{s namespace='frontend/index/checkout_actions' name='OrangebytesShopNavigationBasketLabel'}Warenkorb{/s}</span>
            </span>
        </a>
